            ...
            <div className='weather__container'>
                ...
                <div className='weather__info'>
                    ...
                    <ul className='weather__list'>
                        <li className='weather__item'><span>Wind speed: </span>{weather?.wind.speed} m/s </li>
                        <li className='weather__item'><span>Clouds: </span>{weather?.clouds.all} %</li>
                        <li className='weather__item'><span>Pressure: </span>{weather?.main.pressure} hPa</li>
                    </ul>
                </div>
            </div>
            <h3>
